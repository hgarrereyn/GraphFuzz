...
extern "C" void shim_0(void **in_ref, void **out_ref, const char *context) {
    ...
    uint32_t _a0[256];
    memcpy(&_a0, context + 0, 4 * 256);
    std::cout << "    uint32_t _a0[256] = {";
    for (int i = 0; i < 256; ++i) {
