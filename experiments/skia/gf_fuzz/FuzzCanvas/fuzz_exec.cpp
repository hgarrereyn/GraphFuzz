...
extern "C" void shim_0(void **in_ref, void **out_ref, const char *context) {
    float _a0 = *((float *)(context + 0));
    float _a1 = *((float *)(context + 4));
    SkPoint *_o0;
	_o0 = MAKE(SkPoint);
...
extern "C" void shim_2(void **in_ref, void **out_ref, const char *context) {
    int32_t _a0 = *((int32_t *)(context + 0));
    int32_t _a1 = *((int32_t *)(context + 4));
    int32_t _a2 = *((int32_t *)(context + 8));
    int32_t _a3 = *((int32_t *)(context + 12));
    SkIRect *_o0;
	_o0 = MAKE(SkIRect);
...
extern "C" void shim_6(void **in_ref, void **out_ref, const char *context) {
    SkRect *_i0 = (SkRect *)in_ref[0];
    float _a0 = *((float *)(context + 0));
    float _a1 = *((float *)(context + 4));
    float _a2 = *((float *)(context + 8));
    float _a3 = *((float *)(context + 12));
    float _a4 = *((float *)(context + 16));
    float _a5 = *((float *)(context + 20));
    float _a6 = *((float *)(context + 24));
    float _a7 = *((float *)(context + 28));
    SkRRect *_o0;
    SkRect *_o1;
	_o0 = MAKE(SkRRect);
	*_o0 = SkRRect();
...
extern "C" void shim_9(void **in_ref, void **out_ref, const char *context) {
    SkRegion *_i0 = (SkRegion *)in_ref[0];
    SkIRect *_i1 = (SkIRect *)in_ref[1];
    SkRegion::Op _a0;
    switch (*((unsigned char *)(context + 0)) % 7) {
...
extern "C" void shim_11(void **in_ref, void **out_ref, const char *context) {
    SkMatrix *_i0 = (SkMatrix *)in_ref[0];
    float _a0[6];
    for (int i = 0; i < 6; ++i) _a0[i] = *((float *)(context + 0 + (4 * i)));
    SkMatrix *_o0;
	_i0->setAffine(_a0);
	_o0 = _i0;
...
extern "C" void shim_12(void **in_ref, void **out_ref, const char *context) {
    SkMatrix *_i0 = (SkMatrix *)in_ref[0];
    float _a0[9];
    for (int i = 0; i < 9; ++i) _a0[i] = *((float *)(context + 0 + (4 * i)));
    SkMatrix *_o0;
	_i0->set9(_a0);
	_o0 = _i0;
...
extern "C" void shim_18(void **in_ref, void **out_ref, const char *context) {
    SkPath *_i0 = (SkPath *)in_ref[0];
    SkMatrix *_i1 = (SkMatrix *)in_ref[1];
    SkPath::AddPathMode _a0;
    switch (*((unsigned char *)(context + 0)) % 2) {
...
extern "C" void shim_30(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a4 = *((float *)(context + 16));
    SkPath *_o0;
	_i0->conicTo(_a0, _a1, _a2, _a3, _a4);
	_o0 = _i0;
...
extern "C" void shim_31(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a4 = *((float *)(context + 16));
    SkPath *_o0;
	_i0->rConicTo(_a0, _a1, _a2, _a3, _a4);
	_o0 = _i0;
...
extern "C" void shim_32(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a5 = *((float *)(context + 20));
    SkPath *_o0;
	_i0->cubicTo(_a0, _a1, _a2, _a3, _a4, _a5);
	_o0 = _i0;
...
extern "C" void shim_33(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a5 = *((float *)(context + 20));
    SkPath *_o0;
	_i0->rCubicTo(_a0, _a1, _a2, _a3, _a4, _a5);
	_o0 = _i0;
...
extern "C" void shim_35(void **in_ref, void **out_ref, const char *context) {
    SkPath *_i0 = (SkPath *)in_ref[0];
    SkRect *_i1 = (SkRect *)in_ref[1];
    float _a0 = *((float *)(context + 0));
    float _a1 = *((float *)(context + 4));
    bool _a2 = *((bool *)(context + 8));
    SkPath *_o0;
    SkRect *_o1;
	_i0->arcTo(*_i1, _a0, _a1, _a2);
	_o0 = _i0;
	_o1 = _i1;
...
extern "C" void shim_38(void **in_ref, void **out_ref, const char *context) {
    ...
    int _a1 = *((int *)(context + 1));
    SkPath *_o0;
    SkRect *_o1;
	_i0->addRect(*_i1, _a0, _a1);
	_o0 = _i0;
	_o1 = _i1;
...
extern "C" void shim_46(void **in_ref, void **out_ref, const char *context) {
    SkPath *_i0 = (SkPath *)in_ref[0];
    SkPath *_i1 = (SkPath *)in_ref[1];
    SkMatrix *_i2 = (SkMatrix *)in_ref[2];
    SkPath::AddPathMode _a0;
    switch (*((unsigned char *)(context + 0)) % 2) {
        case 0: _a0 = SkPath::AddPathMode::kAppend_AddPathMode; break;
        case 1: _a0 = SkPath::AddPathMode::kExtend_AddPathMode; break;
...
extern "C" void shim_49(void **in_ref, void **out_ref, const char *context) {
    SkPath *_i0 = (SkPath *)in_ref[0];
    SkMatrix *_i1 = (SkMatrix *)in_ref[1];
    SkPath *_i2 = (SkPath *)in_ref[2];
    SkPath *_o0;
    SkMatrix *_o1;
    SkPath *_o2;
	_i0->transform(*_i1, _i2);
	_o0 = _i0;
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_52(void **in_ref, void **out_ref, const char *context) {
    uint16_t _a0[2];
    for (int i = 0; i < 2; ++i) _a0[i] = *((uint16_t *)(context + 0 + (2 * i)));
    uint32_t _a1[64];
    for (int i = 0; i < 64; ++i) _a1[i] = *((uint32_t *)(context + 4 + (4 * i)));
    uint32_t _a2[64];
    for (int i = 0; i < 64; ++i) _a2[i] = *((uint32_t *)(context + 260 + (4 * i)));
    sk_sp<SkImage> *_o0;
...
extern "C" void shim_53(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkImage> *_i0 = (sk_sp<SkImage> *)in_ref[0];
	free(_i0);
...
extern "C" void shim_55(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkColorFilter> *_i0 = (sk_sp<SkColorFilter> *)in_ref[0];
    sk_sp<SkColorFilter> *_i1 = (sk_sp<SkColorFilter> *)in_ref[1];
    sk_sp<SkColorFilter> *_o0;
...
extern "C" void shim_56(void **in_ref, void **out_ref, const char *context) {
    float _a0[20];
    for (int i = 0; i < 20; ++i) _a0[i] = *((float *)(context + 0 + (4 * i)));
    sk_sp<SkColorFilter> *_o0;
	_o0 = MAKE(sk_sp<SkColorFilter>);
...
extern "C" void shim_57(void **in_ref, void **out_ref, const char *context) {
    bool _a0 = *((bool *)(context + 0));
    SkHighContrastConfig::InvertStyle _a1;
    switch (*((unsigned char *)(context + 1)) % 3) {
...
extern "C" void shim_58(void **in_ref, void **out_ref, const char *context) {
    uint8_t _a0[256];
    for (int i = 0; i < 256; ++i) _a0[i] = *((uint8_t *)(context + 0 + (1 * i)));
    sk_sp<SkColorFilter> *_o0;
	_o0 = MAKE(sk_sp<SkColorFilter>);
...
extern "C" void shim_59(void **in_ref, void **out_ref, const char *context) {
    ...
    for (int i = 0; i < 256; ++i) _a0[i] = *((uint8_t *)(context + 0 + (1 * i)));
    uint8_t _a1[256];
    for (int i = 0; i < 256; ++i) _a1[i] = *((uint8_t *)(context + 256 + (1 * i)));
    uint8_t _a2[256];
    for (int i = 0; i < 256; ++i) _a2[i] = *((uint8_t *)(context + 512 + (1 * i)));
    uint8_t _a3[256];
    for (int i = 0; i < 256; ++i) _a3[i] = *((uint8_t *)(context + 768 + (1 * i)));
    sk_sp<SkColorFilter> *_o0;
	_o0 = MAKE(sk_sp<SkColorFilter>);
...
extern "C" void shim_60(void **in_ref, void **out_ref, const char *context) {
    uint32_t _a0 = *((uint32_t *)(context + 0));
    SkBlendMode _a1;
    switch (*((unsigned char *)(context + 4)) % 32) {
...
extern "C" void shim_61(void **in_ref, void **out_ref, const char *context) {
    uint32_t _a0 = *((uint32_t *)(context + 0));
    uint32_t _a1 = *((uint32_t *)(context + 4));
    sk_sp<SkColorFilter> *_o0;
	_o0 = MAKE(sk_sp<SkColorFilter>);
...
extern "C" void shim_65(void **in_ref, void **out_ref, const char *context) {
    SkPaint *_i0 = (SkPaint *)in_ref[0];
    bool _a0 = *((bool *)(context + 0));
    SkPaint *_o0;
	_i0->setAntiAlias(_a0);
	_o0 = _i0;
...
extern "C" void shim_68(void **in_ref, void **out_ref, const char *context) {
    SkPaint *_i0 = (SkPaint *)in_ref[0];
    SkBlendMode _a0;
    switch (*((unsigned char *)(context + 0)) % 32) {
...
extern "C" void shim_69(void **in_ref, void **out_ref, const char *context) {
    SkPaint *_i0 = (SkPaint *)in_ref[0];
    SkPaint::Style _a0;
    switch (*((unsigned char *)(context + 0)) % 3) {
...
extern "C" void shim_70(void **in_ref, void **out_ref, const char *context) {
    SkPaint *_i0 = (SkPaint *)in_ref[0];
    sk_sp<SkShader> *_i1 = (sk_sp<SkShader> *)in_ref[1];
    SkPaint *_o0;
    sk_sp<SkShader> *_o1;
	_i0->setShader(*_i1);
	_o0 = _i0;
...
extern "C" void shim_71(void **in_ref, void **out_ref, const char *context) {
    SkPaint *_i0 = (SkPaint *)in_ref[0];
    sk_sp<SkPathEffect> *_i1 = (sk_sp<SkPathEffect> *)in_ref[1];
    SkPaint *_o0;
    sk_sp<SkPathEffect> *_o1;
	_i0->setPathEffect(*_i1);
	_o0 = _i0;
	_o1 = _i1;
...
extern "C" void shim_72(void **in_ref, void **out_ref, const char *context) {
    SkPaint *_i0 = (SkPaint *)in_ref[0];
    sk_sp<SkMaskFilter> *_i1 = (sk_sp<SkMaskFilter> *)in_ref[1];
    SkPaint *_o0;
    sk_sp<SkMaskFilter> *_o1;
	_i0->setMaskFilter(*_i1);
	_o0 = _i0;
	_o1 = _i1;
...
extern "C" void shim_73(void **in_ref, void **out_ref, const char *context) {
    SkPaint *_i0 = (SkPaint *)in_ref[0];
    sk_sp<SkImageFilter> *_i1 = (sk_sp<SkImageFilter> *)in_ref[1];
    SkPaint *_o0;
    sk_sp<SkImageFilter> *_o1;
	_i0->setImageFilter(*_i1);
	_o0 = _i0;
	_o1 = _i1;
...
extern "C" void shim_77(void **in_ref, void **out_ref, const char *context) {
    SkPaint *_i0 = (SkPaint *)in_ref[0];
    SkPaint::Cap _a0;
    switch (*((unsigned char *)(context + 0)) % 5) {
...
extern "C" void shim_81(void **in_ref, void **out_ref, const char *context) {
    SkFont *_i0 = (SkFont *)in_ref[0];
    sk_sp<SkTypeface> *_i1 = (sk_sp<SkTypeface> *)in_ref[1];
    SkFont *_o0;
...
extern "C" void shim_90(void **in_ref, void **out_ref, const char *context) {
    SkFont *_i0 = (SkFont *)in_ref[0];
    SkFontHinting _a0;
    switch (*((unsigned char *)(context + 0)) % 4) {
...
extern "C" void shim_96(void **in_ref, void **out_ref, const char *context) {
    SkPoint3 *_i0 = (SkPoint3 *)in_ref[0];
	free(_i0);
...
extern "C" void shim_97(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    SkRect *_i1 = (SkRect *)in_ref[1];
    SkPaint *_i2 = (SkPaint *)in_ref[2];
    sk_sp<SkImageFilter> *_i3 = (sk_sp<SkImageFilter> *)in_ref[3];
    bool _a0 = *((bool *)(context + 0));
    bool _a1 = *((bool *)(context + 1));
    bool _a2 = *((bool *)(context + 2));
    SkCanvas *_o0;
    SkRect *_o1;
    SkPaint *_o2;
...
extern "C" void shim_98(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    SkPaint *_i1 = (SkPaint *)in_ref[1];
    float _a0[60];
    for (int i = 0; i < 60; ++i) _a0[i] = *((float *)(context + 0 + (4 * i)));
    int _a1 = *((int *)(context + 240));
    SkCanvas::PointMode _a2;
    switch (*((unsigned char *)(context + 244)) % 3) {
...
extern "C" void shim_99(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    sk_sp<SkImage> *_i1 = (sk_sp<SkImage> *)in_ref[1];
    SkPaint *_i2 = (SkPaint *)in_ref[2];
    float _a0 = *((float *)(context + 0));
    float _a1 = *((float *)(context + 4));
    bool _a2 = *((bool *)(context + 8));
...
extern "C" void shim_100(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    sk_sp<SkImage> *_i1 = (sk_sp<SkImage> *)in_ref[1];
    SkRect *_i2 = (SkRect *)in_ref[2];
    SkRect *_i3 = (SkRect *)in_ref[3];
    SkPaint *_i4 = (SkPaint *)in_ref[4];
    bool _a0 = *((bool *)(context + 0));
    bool _a1 = *((bool *)(context + 1));
    SkCanvas *_o0;
    sk_sp<SkImage> *_o1;
...
extern "C" void shim_102(void **in_ref, void **out_ref, const char *context) {
    ...
    sk_sp<SkImage> *_i1 = (sk_sp<SkImage> *)in_ref[1];
    SkRect *_i2 = (SkRect *)in_ref[2];
    SkPaint *_i3 = (SkPaint *)in_ref[3];
    int _a0[6];
    for (int i = 0; i < 6; ++i) _a0[i] = *((int *)(context + 0 + (4 * i)));
    int _a1[6];
    for (int i = 0; i < 6; ++i) _a1[i] = *((int *)(context + 24 + (4 * i)));
    int _a2 = *((int *)(context + 48));
    int _a3 = *((int *)(context + 52));
    bool _a4 = *((bool *)(context + 56));
    SkCanvas *_o0;
    sk_sp<SkImage> *_o1;
    SkRect *_o2;
    SkPaint *_o3;
...
extern "C" void shim_103(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    SkFont *_i1 = (SkFont *)in_ref[1];
    SkPaint *_i2 = (SkPaint *)in_ref[2];
    uint8_t _a0[128];
    for (int i = 0; i < 128; ++i) _a0[i] = *((uint8_t *)(context + 0 + (1 * i)));
    float _a1 = *((float *)(context + 128));
    float _a2 = *((float *)(context + 132));
    SkTextEncoding _a3;
    switch (*((unsigned char *)(context + 136)) % 4) {
...
extern "C" void shim_104(void **in_ref, void **out_ref, const char *context) {
    ...
    SkBlendMode _a1;
    switch (*((unsigned char *)(context + 1)) % 32) {
        case 0: _a1 = SkBlendMode::kClear; break;
        case 1: _a1 = SkBlendMode::kSrc; break;
        case 2: _a1 = SkBlendMode::kDst; break;
        case 3: _a1 = SkBlendMode::kSrcOver; break;
    ...
    float _a2[200];
    for (int i = 0; i < 200; ++i) _a2[i] = *((float *)(context + 2 + (4 * i)));
    float _a3[200];
    for (int i = 0; i < 200; ++i) _a3[i] = *((float *)(context + 802 + (4 * i)));
    uint32_t _a4[100];
    for (int i = 0; i < 100; ++i) _a4[i] = *((uint32_t *)(context + 1602 + (4 * i)));
    int _a5 = *((int *)(context + 2002));
    bool _a6 = *((bool *)(context + 2006));
    bool _a7 = *((bool *)(context + 2007));
    bool _a8 = *((bool *)(context + 2008));
    uint16_t _a9[200];
    for (int i = 0; i < 200; ++i) _a9[i] = *((uint16_t *)(context + 2009 + (2 * i)));
    int _a10 = *((int *)(context + 2409));
    SkCanvas *_o0;
    SkPaint *_o1;
...
extern "C" void shim_107(void **in_ref, void **out_ref, const char *context) {
    ...
    SkPaint *_i1 = (SkPaint *)in_ref[1];
    float _a0[24];
    for (int i = 0; i < 24; ++i) _a0[i] = *((float *)(context + 0 + (4 * i)));
    uint32_t _a1[4];
    for (int i = 0; i < 4; ++i) _a1[i] = *((uint32_t *)(context + 96 + (4 * i)));
    float _a2[8];
    for (int i = 0; i < 8; ++i) _a2[i] = *((float *)(context + 112 + (4 * i)));
    bool _a3 = *((bool *)(context + 144));
    SkBlendMode _a4;
    switch (*((unsigned char *)(context + 145)) % 32) {
...
extern "C" void shim_114(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    uint8_t _a0 = *((uint8_t *)(context + 0));
    SkCanvas *_o0;
	_i0->saveLayerAlpha(nullptr, _a0);
	_o0 = _i0;
...
extern "C" void shim_117(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    int _a0 = *((int *)(context + 0));
    SkCanvas *_o0;
	_i0->restoreToCount(_a0);
	_o0 = _i0;
...
extern "C" void shim_129(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    SkRegion *_i1 = (SkRegion *)in_ref[1];
    SkClipOp _a0;
    switch (*((unsigned char *)(context + 0)) % 2) {
        case 0: _a0 = SkClipOp::kDifference; break;
        case 1: _a0 = SkClipOp::kIntersect; break;
...
extern "C" void shim_135(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    SkRRect *_i1 = (SkRRect *)in_ref[1];
    SkRRect *_i2 = (SkRRect *)in_ref[2];
    SkPaint *_i3 = (SkPaint *)in_ref[3];
    SkCanvas *_o0;
    SkRRect *_o1;
    SkRRect *_o2;
    SkPaint *_o3;
	_i0->drawDRRect(*_i1, *_i2, *_i3);
	_o0 = _i0;
	_o1 = _i1;
	_o2 = _i2;
	_o3 = _i3;
...
extern "C" void shim_136(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRect *_o1;
    SkPaint *_o2;
	_i0->drawArc(*_i1, _a0, _a1, _a2, *_i2);
	_o0 = _i0;
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_138(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    sk_sp<SkTextBlob> *_i1 = (sk_sp<SkTextBlob> *)in_ref[1];
    SkPaint *_i2 = (SkPaint *)in_ref[2];
    float _a0 = *((float *)(context + 0));
    float _a1 = *((float *)(context + 4));
    SkCanvas *_o0;
    ...
    SkPaint *_o2;
	_i0->drawTextBlob(*_i1, _a0, _a1, *_i2);
	_o0 = _i0;
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_139(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    sk_sp<SkPicture> *_i1 = (sk_sp<SkPicture> *)in_ref[1];
    SkMatrix *_i2 = (SkMatrix *)in_ref[2];
    SkPaint *_i3 = (SkPaint *)in_ref[3];
    SkCanvas *_o0;
    sk_sp<SkPicture> *_o1;
...
extern "C" void shim_140(void **in_ref, void **out_ref, const char *context) {
    ...
    sk_sp<SkPicture> *_o1;
    SkMatrix *_o2;
	_i0->drawPicture(*_i1, _i2, nullptr);
	_o0 = _i0;
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_141(void **in_ref, void **out_ref, const char *context) {
    ...
    sk_sp<SkPicture> *_o1;
    SkPaint *_o2;
	_i0->drawPicture(*_i1, nullptr, _i2);
	_o0 = _i0;
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_142(void **in_ref, void **out_ref, const char *context) {
    ...
    SkCanvas *_o0;
    sk_sp<SkPicture> *_o1;
	_i0->drawPicture(*_i1, nullptr, nullptr);
	_o0 = _i0;
	_o1 = _i1;
...
extern "C" void shim_144(void **in_ref, void **out_ref, const char *context) {
    SkCanvas *_i0 = (SkCanvas *)in_ref[0];
    SkPoint *_i1 = (SkPoint *)in_ref[1];
    SkPoint *_i2 = (SkPoint *)in_ref[2];
    SkPaint *_i3 = (SkPaint *)in_ref[3];
    SkCanvas *_o0;
    SkPoint *_o1;
    SkPoint *_o2;
    SkPaint *_o3;
	_i0->drawLine(*_i1, *_i2, *_i3);
	_o0 = _i0;
	_o1 = _i1;
	_o2 = _i2;
	_o3 = _i3;
...
extern "C" void shim_148(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRect *_o1;
    SkPaint *_o2;
	_i0->drawRoundRect(*_i1, _a0, _a1, *_i2);
	_o0 = _i0;
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_150(void **in_ref, void **out_ref, const char *context) {
    GFUZZ_BUNDLE *_i0 = (GFUZZ_BUNDLE *)in_ref[0];
    sk_sp<SkPicture> *_o0;
...
extern "C" void shim_151(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkPicture> *_i0 = (sk_sp<SkPicture> *)in_ref[0];
	free(_i0);
...
extern "C" void shim_153(void **in_ref, void **out_ref, const char *context) {
    ...
    SkTileMode _a1;
    switch (*((unsigned char *)(context + 1)) % 5) {
...
extern "C" void shim_154(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkShader> *_i0 = (sk_sp<SkShader> *)in_ref[0];
    SkMatrix *_i1 = (SkMatrix *)in_ref[1];
    sk_sp<SkShader> *_o0;
    sk_sp<SkShader> *_o1;
    SkMatrix *_o2;
...
extern "C" void shim_157(void **in_ref, void **out_ref, const char *context) {
    SkMatrix *_i0 = (SkMatrix *)in_ref[0];
    float _a0[2];
    for (int i = 0; i < 2; ++i) _a0[i] = *((float *)(context + 0 + (4 * i)));
    float _a1[2];
    for (int i = 0; i < 2; ++i) _a1[i] = *((float *)(context + 8 + (4 * i)));
    uint32_t _a2[12];
    for (int i = 0; i < 12; ++i) _a2[i] = *((uint32_t *)(context + 16 + (4 * i)));
    float _a3[12];
    for (int i = 0; i < 12; ++i) _a3[i] = *((float *)(context + 64 + (4 * i)));
    SkTileMode _a4;
    switch (*((unsigned char *)(context + 112)) % 5) {
    ...
    bool _a5[2];
    for (int i = 0; i < 2; ++i) _a5[i] = *((bool *)(context + 113 + (1 * i)));
    int _a6 = *((int *)(context + 115));
    sk_sp<SkShader> *_o0;
    SkMatrix *_o1;
	_o0 = MAKE(sk_sp<SkShader>);
...
extern "C" void shim_158(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a0[2];
    for (int i = 0; i < 2; ++i) _a0[i] = *((float *)(context + 0 + (4 * i)));
    float _a1 = *((float *)(context + 8));
    uint32_t _a2[12];
    for (int i = 0; i < 12; ++i) _a2[i] = *((uint32_t *)(context + 12 + (4 * i)));
    float _a3[12];
    for (int i = 0; i < 12; ++i) _a3[i] = *((float *)(context + 60 + (4 * i)));
    SkTileMode _a4;
    switch (*((unsigned char *)(context + 108)) % 5) {
        case 0: _a4 = SkTileMode::kClamp; break;
        case 1: _a4 = SkTileMode::kRepeat; break;
        case 2: _a4 = SkTileMode::kMirror; break;
        case 3: _a4 = SkTileMode::kDecal; break;
    ...
    bool _a5[2];
    for (int i = 0; i < 2; ++i) _a5[i] = *((bool *)(context + 109 + (1 * i)));
    int _a6 = *((int *)(context + 111));
    sk_sp<SkShader> *_o0;
    SkMatrix *_o1;
	_o0 = MAKE(sk_sp<SkShader>);
...
extern "C" void shim_159(void **in_ref, void **out_ref, const char *context) {
    SkMatrix *_i0 = (SkMatrix *)in_ref[0];
    float _a0[4];
    for (int i = 0; i < 4; ++i) _a0[i] = *((float *)(context + 0 + (4 * i)));
    float _a1[2];
    for (int i = 0; i < 2; ++i) _a1[i] = *((float *)(context + 16 + (4 * i)));
    uint32_t _a2[12];
    for (int i = 0; i < 12; ++i) _a2[i] = *((uint32_t *)(context + 24 + (4 * i)));
    float _a3[12];
    for (int i = 0; i < 12; ++i) _a3[i] = *((float *)(context + 72 + (4 * i)));
    SkTileMode _a4;
    switch (*((unsigned char *)(context + 120)) % 5) {
        case 0: _a4 = SkTileMode::kClamp; break;
        case 1: _a4 = SkTileMode::kRepeat; break;
        case 2: _a4 = SkTileMode::kMirror; break;
        case 3: _a4 = SkTileMode::kDecal; break;
    ...
    bool _a5[2];
    for (int i = 0; i < 2; ++i) _a5[i] = *((bool *)(context + 121 + (1 * i)));
    int _a6 = *((int *)(context + 123));
    sk_sp<SkShader> *_o0;
    SkMatrix *_o1;
	_o0 = MAKE(sk_sp<SkShader>);
...
extern "C" void shim_167(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a1 = *((float *)(context + 4));
    float _a2[20];
    for (int i = 0; i < 20; ++i) _a2[i] = *((float *)(context + 8 + (4 * i)));
    sk_sp<SkPathEffect> *_o0;
	_o0 = MAKE(sk_sp<SkPathEffect>);
	int count = _a0;
	if (count < 0) count = 0;
...
extern "C" void shim_168(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkPathEffect> *_i0 = (sk_sp<SkPathEffect> *)in_ref[0];
    sk_sp<SkPathEffect> *_i1 = (sk_sp<SkPathEffect> *)in_ref[1];
    sk_sp<SkPathEffect> *_o0;
    sk_sp<SkPathEffect> *_o1;
...
extern "C" void shim_170(void **in_ref, void **out_ref, const char *context) {
    ...
    switch (*((unsigned char *)(context + 8)) % 3) {
...
extern "C" void shim_174(void **in_ref, void **out_ref, const char *context) {
    float _a0 = *((float *)(context + 0));
    float _a1 = *((float *)(context + 4));
    uint32_t _a2 = *((uint32_t *)(context + 8));
    sk_sp<SkPathEffect> *_o0;
	_o0 = MAKE(sk_sp<SkPathEffect>);
...
extern "C" void shim_177(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a1 = *((float *)(context + 1));
    bool _a2 = *((bool *)(context + 5));
    sk_sp<SkMaskFilter> *_o0;
	_o0 = MAKE(sk_sp<SkMaskFilter>);
...
extern "C" void shim_178(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkMaskFilter> *_i0 = (sk_sp<SkMaskFilter> *)in_ref[0];
	free(_i0);
...
extern "C" void shim_181(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkTypeface> *_i0 = (sk_sp<SkTypeface> *)in_ref[0];
	free(_i0);
...
extern "C" void shim_183(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkImageFilter> *_i0 = (sk_sp<SkImageFilter> *)in_ref[0];
    SkMatrix *_i1 = (SkMatrix *)in_ref[1];
    SkFilterQuality _a0;
    switch (*((unsigned char *)(context + 0)) % 5) {
...
extern "C" void shim_185(void **in_ref, void **out_ref, const char *context) {
    ...
    SkIRect *_i1 = (SkIRect *)in_ref[1];
    uint8_t _a0 = *((uint8_t *)(context + 0));
    uint8_t _a1 = *((uint8_t *)(context + 1));
    float _a2[25];
    for (int i = 0; i < 25; ++i) _a2[i] = *((float *)(context + 2 + (4 * i)));
    float _a3 = *((float *)(context + 102));
    float _a4 = *((float *)(context + 106));
    uint8_t _a5 = *((uint8_t *)(context + 110));
    uint8_t _a6 = *((uint8_t *)(context + 111));
    SkTileMode _a7;
    switch (*((unsigned char *)(context + 112)) % 5) {
    ...
    bool _a8 = *((bool *)(context + 113));
    bool _a9 = *((bool *)(context + 114));
    sk_sp<SkImageFilter> *_o0;
    sk_sp<SkImageFilter> *_o1;
    SkIRect *_o2;
	int32_t n = (_a0 % (5-1)) + 1;
...
extern "C" void shim_188(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkImageFilter> *_i0 = (sk_sp<SkImageFilter> *)in_ref[0];
    sk_sp<SkImageFilter> *_i1 = (sk_sp<SkImageFilter> *)in_ref[1];
    sk_sp<SkImageFilter> *_i2 = (sk_sp<SkImageFilter> *)in_ref[2];
    SkIRect *_i3 = (SkIRect *)in_ref[3];
    bool _a0 = *((bool *)(context + 0));
    sk_sp<SkImageFilter> *_o0;
    sk_sp<SkImageFilter> *_o1;
    sk_sp<SkImageFilter> *_o2;
...
/* CPPScope(name=(auto) sk_sp<SkImageFilter>::sk_sp<SkImageFilter> SkImageFilters::SpotLitDiffuse(SkPoint3 p, SkPoint3 q, SkScalar specularExponent, SkScalar cutoffAngle, SkScalar lightColor, SkScalar surfaceScale, SkScalar k, sk_sp<SkImageFilter> input, SkIRect * cropRect);) */
extern "C" void shim_194(void **in_ref, void **out_ref, const char *context) {
    SkPoint3 *_i0 = (SkPoint3 *)in_ref[0];
    SkPoint3 *_i1 = (SkPoint3 *)in_ref[1];
    sk_sp<SkImageFilter> *_i2 = (sk_sp<SkImageFilter> *)in_ref[2];
    SkIRect *_i3 = (SkIRect *)in_ref[3];
    float _a0 = *((float *)(context + 0));
    float _a1 = *((float *)(context + 4));
...
/* CPPScope(name=(auto) sk_sp<SkImageFilter>::sk_sp<SkImageFilter> SkImageFilters::SpotLitDiffuse(SkPoint3 p, SkPoint3 q, SkScalar specularExponent, SkScalar cutoffAngle, SkScalar lightColor, SkScalar surfaceScale, SkScalar k, sk_sp<SkImageFilter> input, {nullptr});) */
...
/* CPPScope(name=(auto) sk_sp<SkImageFilter>::sk_sp<SkImageFilter> SkImageFilters::DistantLitSpecular(SkPoint3 p, SkScalar lightColor, SkScalar surfaceScale, SkScalar k, SkScalar shininess, sk_sp<SkImageFilter> input, SkIRect * cropRect);) */
...
/* CPPScope(name=(auto) sk_sp<SkImageFilter>::sk_sp<SkImageFilter> SkImageFilters::DistantLitSpecular(SkPoint3 p, SkScalar lightColor, SkScalar surfaceScale, SkScalar k, SkScalar shininess, sk_sp<SkImageFilter> input, {nullptr});) */
...
/* CPPScope(name=(auto) sk_sp<SkImageFilter>::sk_sp<SkImageFilter> SkImageFilters::PointLitSpecular(SkPoint3 p, SkScalar lightColor, SkScalar surfaceScale, SkScalar k, SkScalar shininess, sk_sp<SkImageFilter> input, SkIRect * cropRect);) */
...
/* CPPScope(name=(auto) sk_sp<SkImageFilter>::sk_sp<SkImageFilter> SkImageFilters::PointLitSpecular(SkPoint3 p, SkScalar lightColor, SkScalar surfaceScale, SkScalar k, SkScalar shininess, sk_sp<SkImageFilter> input, {nullptr});) */
...
/* CPPScope(name=(auto) sk_sp<SkImageFilter>::sk_sp<SkImageFilter> SkImageFilters::SpotLitSpecular(SkPoint3 p, SkPoint3 q, SkScalar specularExponent, SkScalar cutoffAngle, SkScalar lightColor, SkScalar surfaceScale, SkScalar k, SkScalar shininess, sk_sp<SkImageFilter> input, SkIRect * cropRect);) */
...
/* CPPScope(name=(auto) sk_sp<SkImageFilter>::sk_sp<SkImageFilter> SkImageFilters::SpotLitSpecular(SkPoint3 p, SkPoint3 q, SkScalar specularExponent, SkScalar cutoffAngle, SkScalar lightColor, SkScalar surfaceScale, SkScalar k, SkScalar shininess, sk_sp<SkImageFilter> input, {nullptr});) */
...
extern "C" void shim_213(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a2 = *((float *)(context + 8));
    float _a3 = *((float *)(context + 12));
    uint32_t _a4 = *((uint32_t *)(context + 16));
    sk_sp<SkImageFilter> *_o0;
    sk_sp<SkImageFilter> *_o1;
    SkIRect *_o2;
	_o0 = MAKE(sk_sp<SkImageFilter>);
...
extern "C" void shim_238(void **in_ref, void **out_ref, const char *context) {
    sk_sp<SkTextBlob> *_i0 = (sk_sp<SkTextBlob> *)in_ref[0];
	free(_i0);
...
extern "C" void shim_240(void **in_ref, void **out_ref, const char *context) {
    SkTextBlobBuilder *_i0 = (SkTextBlobBuilder *)in_ref[0];
	delete _i0;
...
extern "C" void shim_242(void **in_ref, void **out_ref, const char *context) {
    ...
    for (int i = 0; i < 128; ++i) _a0[i] = *((uint8_t *)(context + 0 + (1 * i)));
    SkTextEncoding _a1;
    switch (*((unsigned char *)(context + 128)) % 4) {
    ...
    float _a2 = *((float *)(context + 129));
    float _a3 = *((float *)(context + 133));
    SkTextBlobBuilder *_o0;
    SkFont *_o1;
	Fuzz f(_a0, 128);
...
extern "C" void shim_243(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a2 = *((float *)(context + 129));
    float _a3[32];
    for (int i = 0; i < 32; ++i) _a3[i] = *((float *)(context + 133 + (4 * i)));
    SkTextBlobBuilder *_o0;
    SkFont *_o1;
	Fuzz f(_a0, 128);
	SkTDArray<uint8_t> text = make_fuzz_text(&f, *_i1, _a1);
...
extern "C" void shim_244(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a2[64];
    for (int i = 0; i < 64; ++i) _a2[i] = *((float *)(context + 129 + (4 * i)));
    SkTextBlobBuilder *_o0;
    SkFont *_o1;
	Fuzz f(_a0, 128);
	SkTDArray<uint8_t> text = make_fuzz_text(&f, *_i1, _a1);
...
extern "C" void shim_258(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRect *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->saveLayer(_i1, _i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_259(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkRect *_o1;
	((SkCanvas *)_i0->active)->saveLayer(_i1, nullptr);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_260(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkPaint *_o1;
	((SkCanvas *)_i0->active)->saveLayer(nullptr, _i1);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_261(void **in_ref, void **out_ref, const char *context) {
    GFUZZ_BUNDLE *_i0 = (GFUZZ_BUNDLE *)in_ref[0];
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->saveLayer(nullptr, nullptr);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_262(void **in_ref, void **out_ref, const char *context) {
    ...
    uint8_t _a0 = *((uint8_t *)(context + 0));
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->saveLayerAlpha(nullptr, _a0);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_263(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkRect *_o1;
	((SkCanvas *)_i0->active)->saveLayerAlpha(_i1, _a0);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_265(void **in_ref, void **out_ref, const char *context) {
    ...
    int _a0 = *((int *)(context + 0));
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->restoreToCount(_a0);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_266(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a1 = *((float *)(context + 4));
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->translate(_a0, _a1);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_267(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a1 = *((float *)(context + 4));
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->scale(_a0, _a1);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_268(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a0 = *((float *)(context + 0));
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->rotate(_a0);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_269(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a2 = *((float *)(context + 8));
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->rotate(_a0, _a1, _a2);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_270(void **in_ref, void **out_ref, const char *context) {
    ...
    float _a1 = *((float *)(context + 4));
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->skew(_a0, _a1);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_271(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkMatrix *_o1;
	((SkCanvas *)_i0->active)->concat(*_i1);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_272(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkMatrix *_o1;
	((SkCanvas *)_i0->active)->setMatrix(*_i1);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_273(void **in_ref, void **out_ref, const char *context) {
    GFUZZ_BUNDLE *_i0 = (GFUZZ_BUNDLE *)in_ref[0];
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->resetMatrix();
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_274(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkRect *_o1;
	((SkCanvas *)_i0->active)->clipRect(*_i1, _a0, _a1);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_275(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkRRect *_o1;
	((SkCanvas *)_i0->active)->clipRRect(*_i1, _a0, _a1);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_276(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkPath *_o1;
	((SkCanvas *)_i0->active)->clipPath(*_i1, _a0, _a1);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_277(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkRegion *_o1;
	((SkCanvas *)_i0->active)->clipRegion(*_i1, _a0);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_278(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    SkPaint *_o1;
	((SkCanvas *)_i0->active)->drawPaint(*_i1);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_279(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRect *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawRect(*_i1, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_280(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRegion *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawRegion(*_i1, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_281(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRect *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawOval(*_i1, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_282(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRRect *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawRRect(*_i1, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_283(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRRect *_o2;
    SkPaint *_o3;
	((SkCanvas *)_i0->active)->drawDRRect(*_i1, *_i2, *_i3);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
	_o3 = _i3;
...
extern "C" void shim_284(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRect *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawArc(*_i1, _a0, _a1, _a2, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_285(void **in_ref, void **out_ref, const char *context) {
    ...
    SkPath *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawPath(*_i1, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_286(void **in_ref, void **out_ref, const char *context) {
    ...
    sk_sp<SkTextBlob> *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawTextBlob(*_i1, _a0, _a1, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_287(void **in_ref, void **out_ref, const char *context) {
    ...
    SkMatrix *_o2;
    SkPaint *_o3;
	((SkCanvas *)_i0->active)->drawPicture(*_i1, _i2, _i3);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
	_o3 = _i3;
...
extern "C" void shim_288(void **in_ref, void **out_ref, const char *context) {
    ...
    sk_sp<SkPicture> *_o1;
    SkMatrix *_o2;
	((SkCanvas *)_i0->active)->drawPicture(*_i1, _i2, nullptr);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_289(void **in_ref, void **out_ref, const char *context) {
    ...
    sk_sp<SkPicture> *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawPicture(*_i1, nullptr, _i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_290(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
    sk_sp<SkPicture> *_o1;
	((SkCanvas *)_i0->active)->drawPicture(*_i1, nullptr, nullptr);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
...
extern "C" void shim_291(void **in_ref, void **out_ref, const char *context) {
    ...
    GFUZZ_BUNDLE *_o0 = (GFUZZ_BUNDLE *)in_ref[0];
	((SkCanvas *)_i0->active)->drawColor(_a0, _a1);
	(_o0->active) = ((SkCanvas *)_i0->active);
...
extern "C" void shim_292(void **in_ref, void **out_ref, const char *context) {
    ...
    SkPoint *_o2;
    SkPaint *_o3;
	((SkCanvas *)_i0->active)->drawLine(*_i1, *_i2, *_i3);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
	_o3 = _i3;
...
extern "C" void shim_293(void **in_ref, void **out_ref, const char *context) {
    ...
    SkIRect *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawIRect(*_i1, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_294(void **in_ref, void **out_ref, const char *context) {
    ...
    SkPoint *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawCircle(*_i1, _a0, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
extern "C" void shim_296(void **in_ref, void **out_ref, const char *context) {
    ...
    SkRect *_o1;
    SkPaint *_o2;
	((SkCanvas *)_i0->active)->drawRoundRect(*_i1, _a0, _a1, *_i2);
	(_o0->active) = ((SkCanvas *)_i0->active);
	_o1 = _i1;
	_o2 = _i2;
...
void (*FUZZER_SHIMS[])(void **, void **, const char *) = {
    &shim_0,
    &shim_1,
    &shim_2,
    &shim_3,
